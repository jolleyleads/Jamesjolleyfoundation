def app(environ, start_response):
    ...
    if path == "/health":
        body = b'{"status":"online","project":"James Jolley Foundation","mission":"Turning Losses Into Lifelines"}'
...
h1{color:#d4af37;font-size:48px}
...
<div class="card">
<h2>DOE Framework</h2>
<p><b>D:</b> Directives — Save lives, accept donations, capture urgent help requests.</p>
